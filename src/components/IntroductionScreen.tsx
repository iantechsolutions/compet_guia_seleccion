            ...
            <div className={'min-h-[calc(90vh_-_100px)]'}>
                <header className="container relative">
                    ...
                    <p className="sm:text-lg">
                        Mediante esta guía de selección ud. podrá encontrar el
                        kit adecuado según el nivel de tensión, tipo/sección de
                        cable y categoría de accesorio necesario. Luego de
                        completar la información solicitada, recibirá nuestra
                        recomendación de producto junto a la información técnica
                        relacionada.
                    </p>
                </header>
