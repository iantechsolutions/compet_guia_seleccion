    ...
    .object({
        ...
        CAMPOS_ADICIONALES: z
            ...
            .transform((value) => {
                ...
                return adittionalFieldsSchema.parse(xmlParsed)
                    .CAMPOS_ADICIONALES
            })
    })
    .transform((value) => {
...
export type ProductTransformedFilters = z.infer<
    typeof productTransformedFiltersSchema
>

export const transformedProductSchema = productSchema.and(
...
export const filterDefinitionRowSchema = z.object({
    ...
    rowdata: z.array(
        z.array(filterDefinitionCheckboxSchema.or(filterDefinitionSelectSchema))
    )
})
...
export const filterDefinitionTabsGroupSchema = z.object({
    ...
    tabsdata: z.array(
        z.array(
            filterDefinitionCheckboxSchema
                .or(filterDefinitionSelectSchema)
                .or(filterDefinitionRowSchema)
        )
    ),
...
export const dataStructureDefinitionSchema = z.array(
    filterDefinitionTabsGroupSchema.or(
        filterDefinitionCheckboxSchema
            .or(filterDefinitionSelectSchema)
            .or(filterDefinitionRowSchema)
    )
...
export type RawDataStructureDefinition = z.infer<
    typeof dataStructureDefinitionSchema
>

// ---> Extracted filters (see extract_filters.ts)

export const singleTransformedFilterSchema = z.array(
    z.object({
        key: z.string(),
        label: z.string()
    })
)
export type SingleTransformedFilter = z.infer<
    typeof singleTransformedFilterSchema
>
...
export type TypedSingleTransformedFilter = z.infer<
    typeof typedSingleTransformedFilterSchema
>

export const extractedFiltersSchema = z.record(
    typedSingleTransformedFilterSchema
)
...
export const importedQuestionFilterSchema = questionFilterSchema
    .pick({
        icon: true,
        key: true,
        label: true,
...
export type ImportedQuestionFilter = z.infer<
    typeof importedQuestionFilterSchema
>
